      ...
      <div role="tabpanel" class="tab-pane active" id="eqlogictab">
        ...
        <form class="form-horizontal">
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-md-3 control-label">{{Virtuel}}</label>
              <div class="col-md-3">
                <select required class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="virtuel">
                  <option value="" disabled selected>{{Sélectionnez un virtuel}}</option>
                  <?php
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label help"
                data-help="{{Adresse IP attribuée au premier lancement du module}}">{{Adresse IP du module :}}</label>
              <div class="col-sm-4">
...
<?php include_file('desktop', 'jeedisplay', 'js', 'jeedisplay');?>
